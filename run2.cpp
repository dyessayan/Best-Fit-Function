...
int mutation_multiplier = 15;
double NODE_CHANGEOP_PROBABILITY        = mutation_multiplier * 0.05;
double NODE_ADD_PROBABILITY             = mutation_multiplier *0.05;
double NODE_DEL_PROBABILITY             = mutation_multiplier *0.05;

//probabilities to mutate subtrees
double SUBTREE_MUTATION_PROBABILITY     = mutation_multiplier *0.03;
double ADD_SUBTREE_MUTATION_PROBABILITY = mutation_multiplier *0.02;
double REM_SUBTREE_MUTATION_PROBABILITY = mutation_multiplier *0.02;

//crossover probability
double CROSSOVER_PROBABILITY             = 0.60;
...
double evaluate(Node* node, double x) {
    ...
    // need to make sure to pass the value of x to this function
...
int main() {
    ...
    int num_repeats    = 3;
    long double PARSIMONY_COEFFICIENT = 0.0005; //You may want to use smaller values if the function is more complex than this one
    std::vector<long double> coefficient_values {1, 0.1, 0.01, 0.001, 0.0001}; //0.1
    // set parsimony coefficient on line 1102
    std::vector<int> tournament_sizes {2, 5, 10, 15, 20 }; //10
    // set tournament size on line 1171
    std::vector<double> crossover_probs = {0.99, 0.9, 0.8, 0.6, 0.3}; //0.9
    // set crossover probability at the top of the file
